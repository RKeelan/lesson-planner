...
export function pageSize(
  ...
  assert(presentation.pageSize?.width?.magnitude, 'Presentation width is required');
  assert(presentation.pageSize?.height?.magnitude, 'Presentation height is required');
  return {
